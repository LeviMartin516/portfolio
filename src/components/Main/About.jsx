...
import vuejsicon from '../../img/vue.jpg';
import nextjsicon from '../../img/next-js.svg';
import golang from '../../img/golang.svg';
import tailwindcss from '../../img/tailwind-css.svg';
import MySQL from '../../img/mysql.svg';
import Postgressql from '../../img/postgresql.svg';
/* Multi idioma */
        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <p>
                    <FormattedMessage
                        id='my-description'
                        defaultMessage='Passionate Front-End Developer with over +7 years of experience in web development.Planned, developed, tested,
                        deployed and maintained web applications. Proficient in various platforms, languages, and embedded systems.
                        Effectively translated client requirements into application designs and systems requirements. Followed policies and
                        procedures related to application methods and quality standards at all times. Able to effectively self-manage during
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Sports(Volleyball, Football), Game and Programming
                        </p>
                    </li>
                    <li>
                        <p><span>Email:</span> david.web.dev.116@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
                            ...
                            Podchorążych 01A/15, 22-721 Płazów, Poland
                        </p>
                    </li>
                </ul>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="Typescript" className="icons-skils" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/angular/angular-original.svg" />
                        <h5>Angular</h5>
                    </div>
                    <div>
                        <img alt="Vue" className="icons-skils" src={vuejsicon} />
                        <h5>Vue</h5>
                    </div>
                    <div>
                        <img alt="next.js" className="icons-skils" src={nextjsicon} />
                        <h5>Next.js</h5>
                    </div>
                    <div>
                    ...
                    <div>
                        <img alt="next.js" className="icons-skils" src={tailwindcss} />
                        <h5>TailWindCSS</h5>
                    </div>      
                </div>
                <h4>Back-End</h4>
                <div className="skill">
                    ...
                    <div>
                        <img alt="mongodb" className="icons-skils" src={golang} />
                        <h5>golang</h5>
                    </div>
                    <div>
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="mongodb" className="icons-skils" src={MySQL} />
                        <h5>MySQL</h5>
                    </div>
                    <div>
                        <img alt="php" className="icons-skils" src={Postgressql } />
                        <h5>PostGresSQL</h5>
                    </div>
                </div>
                <h4>
